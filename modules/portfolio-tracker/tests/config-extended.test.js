...
describe("Config — all 30+ fields", () => {
    it("loads ALL fields with explicit values", () => {
        const cfg = new Config({
            ...
            NOTIFICATION_EMAIL: "alerts@mail.com",
        ...
        expect(cfg.imapUsername).toBe("darren@mail.com");
        ...
        expect(cfg.notificationEmail).toBe("alerts@mail.com");

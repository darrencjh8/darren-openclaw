...
- [x] Write `config/actual_config.json` (minimal: `{"api_url": "http://flyio-frosty-glitter-5667.fly.dev"}`)
- [x] Write `config/email_config.json` (minimal: `{"imap_host": "imap.zoho.com", "imap_port": 993}`)
- [x] Implement `config/__init__.py` that loads JSON configs

...
class TestImapIdleHandler:
    ...
    def test_init_stores_config(self):
        ...
        handler = ImapIdleHandler(
            "imap.example.com", 993, "user@example.com", "app-pass"
        )
        assert handler._host == "imap.example.com"
        assert handler._port == 993
        assert handler._username == "user@example.com"
    ...
    async def test_connect_logs_in_and_selects_inbox(self):
        ...
        handler = ImapIdleHandler("imap.example.com", 993, "user@example.com", "pass")
        ...
        mock_imap.login.assert_called_once_with("user@example.com", "pass")

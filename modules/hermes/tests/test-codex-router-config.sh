...
for required in ("auto-thinking", "gpt-5.6-terra", "deepseek-v4-flash"):
...
if problems:
    ...
    print("OK: default=codex-router/auto-thinking; models=auto-thinking,gpt-5.6-terra,deepseek-v4-flash")
PY
)
